      ...
      <Row className="footer-row">
        <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }} className="footer-col">
          <ul className="footer-list">
            <li><Link to="/about" className="external-link" onClick={handleAboutClick}>Về chúng tôi</Link></li>
            <li><a href="https://daynghe.30shine.com/" className="external-link" target="_blank" rel="noopener noreferrer">Học cắt tóc </a></li>
            <li><a href="#" className={'external-link'}>30Shine shop</a></li>
          </ul>
        </Col>
