...
import { Outlet, useLocation } from 'react-router-dom';
  ...
  const Wage = () => {
    ...
    const isRootPath = location.pathname === '/wage'
    return (
      <div className={styles.main}>
        {isRootPath
          ?
            (
              <><NavLink currentPage="Wage" /><div className={styles.tableGroup}>
                  <HeaderButton text="Import wage" add={true} linkToAdd='importWage'/>
